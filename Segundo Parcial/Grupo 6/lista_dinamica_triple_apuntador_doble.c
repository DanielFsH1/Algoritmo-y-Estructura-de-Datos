...
void meter_dato(Lista *lista, int dato) {
    ...
    if (lista_vacia(lista)) {
        ...
        lista->pmedio = &lista->inicio; // triple apuntador apunta al inicio
        nuevo->sig = nuevo->ant = NULL;
    } else {
        nuevo->sig = NULL;
        ...
        lista->final = nuevo;
        // Actualización de pmedio opcional según lógica de uso
    }
}
...
// El resto del código ya está implementado correctamente para la estructura solicitada.
// Si deseas que la lógica de pmedio se use para alguna operación especial, puedes agregarla aquí.
// Por defecto, pmedio apunta al inicio cuando la lista tiene elementos.
